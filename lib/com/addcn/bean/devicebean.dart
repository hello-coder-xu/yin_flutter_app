...
part 'devicebean.g.dart';


@JsonSerializable()
class Devicebean extends Object {
  ...
  Devicebean(this.data,this.errorCode,this.errorMsg,);

  factory Devicebean.fromJson(Map<String, dynamic> srcJson) => _$DevicebeanFromJson(srcJson);

  Map<String, dynamic> toJson() => _$DevicebeanToJson(this);
